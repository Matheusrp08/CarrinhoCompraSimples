...
public class RestCarrinhoController {
    ...
    public @ResponseBody
    Resposta adicionarProduto(@RequestBody Produto produto) {
        Resposta resposta = new Resposta();
        try {
    ...
    public @ResponseBody
    Resposta atualizarQuantidadeProduto(@RequestBody Produto produto, @PathVariable Long id) {
        Resposta resposta = new Resposta();
    ...
    public @ResponseBody
    Resposta removerProdutoCarrinho(@PathVariable Long id) {
        Resposta resposta = new Resposta();
